    ...
    if (isOpen) {
      ...
      if (results.length === 0) {
        ...
        for (let i = 0; i < this.resultsLimit; i++) {
          ...
          let userIcon = createCustomElement('span', { class: 'image-xsmall avatar me-3' }, [`<img class="avatar-image d-block" src="https://res.cloudinary.com/darrelmasis/image/upload/${resultItem.avatar}">`])
